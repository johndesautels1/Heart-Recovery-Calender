...
const exercises: ExerciseSeedData[] = [
  ...
  // ANKLE/FOOT EXERCISES - Prevent blood clots
  {
    ...
    formTips: 'Move only at the ankle, keep legs still and relaxed. Point and flex through full range of motion without pain. Breathe normally throughout - don\'t hold breath. Move smoothly and rhythmically. Can be done hourly throughout the day, espeCAIlly important during bed rest.',
  ...
  },
  {
    ...
    recoveryBenefit: 'Strengthens glutes and hamstrings cruCAIl for walking and standing, improves posterior chain strength, supports lower back',
    defaultSets: 2,
    defaultReps: 10,
    defaultDuration: 5,
    isActive: true,
  ...
  },
  {
    ...
    recoveryBenefit: 'SoCAIl exercise environment, low-impact full-body workout, water resistance builds strength, fun and motivating',
    defaultSets: 1,
    defaultReps: 1,
    defaultDuration: 45,
    isActive: true,
  ...
  },
  {
    ...
    minPostOpWeek: 11,
    maxPostOpWeek: null,
    instructions: '1. Join appropriate level class\n2. Inform instructor of cardiac history\n3. Modify exercises as needed\n4. Work at sustainable pace\n5. Enjoy soCAIl aspect',
    recoveryBenefit: 'SoCAIl support critical for long-term adherence, professional guidance, full-body workout, accountability and motivation',
    defaultSets: 1,
    defaultReps: 1,
    defaultDuration: 45,
    isActive: true,
  ...
  },
  {
    ...
    minPostOpWeek: 11,
    maxPostOpWeek: null,
    contraindications: 'Only with physiCAIn approval, sternum must be fully healed',
  ...
  },
  {
    ...
    defaultDuration: 40,
    isActive: true,
    formTips: 'Warm up with light paddle volleys before playing. Smaller court means less running than tennis. Stay hydrated throughout play. Monitor breathing - should be able to talk during breaks. Stop if experiencing any cardiac symptoms. Great soCAIl sport that builds confidence.',
  ...
  },
  {
    ...
    defaultDuration: 35,
    isActive: true,
    formTips: 'Warm up on flat ground for 5-10 minutes. Use gears to maintain steady effort on hills - don\'t strain. Monitor heart rate espeCAIlly on inclines. Stand carefully when climbing - puts more strain on heart. Stop at top of hills to check recovery.',
  ...
  },
  {
    ...
    defaultDuration: 30,
    isActive: true,
    formTips: 'Start with slower tempo songs. Take breaks between dances to check heart rate and catch breath. Stay hydrated. Avoid jerky movements or spinning if dizzy. Choose dances you\'re comfortable with. SoCAIl aspect provides motivation and accountability.',
    modifications: 'Easier: Dance to slower songs only, sit out every other dance, practice at home first, chair dancing for very gentle option. Harder: Extend session to 45-60 minutes, try faster tempo music, add dance classes, vary dance styles (ballroom, line dancing, salsa). Make it soCAIl and fun.',
  },
  {
    name: 'Golf (Walking)',
    ...
    defaultDuration: 120,
    isActive: true,
    formTips: 'Use pull cart or carry light bag - avoid heavy bags on one shoulder. Walk at steady pace between shots. Stay hydrated espeCAIlly in heat. Take cart for first few holes if needed. Avoid full power swings initially - focus on technique. Stop if feeling overly fatigued.',
    modifications: 'Easier: Play 9 holes instead of 18, use cart for first 9 then walk back 9, use pull cart, play during cooler times of day. Harder: Walk full 18 holes, carry light bag, play multiple rounds per week. Golf combines walking, soCAIl interaction, and enjoyment.',
  },
  {
  ...
  },
  {
    ...
    defaultDuration: 60,
    isActive: true,
    formTips: 'Start with lighter ball than usual (10-12 lbs or less). Focus on smooth delivery, not power. Take breaks between frames if needed. Good soCAIl activity that keeps you moving. Avoid heavy balls or aggressive throwing initially. Let arm swing naturally without forcing.',
